...
function Inkscape(inkscapeArgs) {
  ...
  if (
    inkscapeArgs &&
    inkscapeArgs.some(function(inkscapeArg) {
      return /^--verb/.test(inkscapeArg);
    })
  ) {
    this.guiMode = true;
  } else {
  ...
  (inkscapeArgs || []).forEach(
    function(inkscapeArg) {
      var matchInkscapeArg = inkscapeArg.match(
